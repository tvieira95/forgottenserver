local advertising = ChatChannel(5, "Advertising")
advertising:public(true)

function advertising.canJoin(player)
...
function advertising.onSpeak(player, type, message)
